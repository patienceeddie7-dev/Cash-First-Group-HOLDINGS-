    ...
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 space-y-6">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 text-white flex justify-between items-center shadow-xl">
        <div className="flex items-center gap-4">
          <div className="w-16 h-16 rounded-2xl bg-blue-600 border-2 border-blue-400 overflow-hidden flex items-center justify-center font-black text-2xl text-white">
