...
export const CustomerManagement: React.FC = () => {
  ...
  const handleSendDirectSMS = (e: React.FormEvent) => {
    ...
    alert(`Direct SMS dispatched to ${selectedCustomer.fullName} (${selectedCustomer.phone})`);
    setMsgInput('');
  };
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      {cust.avatarUrl ? (
                        <img src={cust.avatarUrl} alt={cust.fullName} className="w-10 h-10 rounded-full object-cover border border-slate-200" />
                      ) : (
              ...
              <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                <div className="flex items-center gap-3">
                  {selectedCustomer.avatarUrl ? (
                    <img src={selectedCustomer.avatarUrl} alt="Avatar" className="w-12 h-12 rounded-full object-cover border border-slate-200" />
                  ) : (
                    <div className="w-12 h-12 rounded-full bg-teal-100 text-teal-800 font-bold flex items-center justify-center text-base">
